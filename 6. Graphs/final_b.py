...
---ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ---
    ...
    Список смежности - O(n^2 / 2) дополнительной памяти, где n - количество вершин,
    так как все мЕньшие города соединены с бОльшими, то получается "половинчатая"
    матрица смежности (по количеству элементов)
