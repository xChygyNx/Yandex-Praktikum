...
--- ВРЕМЕННАЯ СЛОЖНОСТЬ --- 
    ...
    Считывание и сохранение документов занимает O(n), процесс подсчета релевантности
    O((n * u1) * (m * u2)),где n - количество документов, m - количество запросов,
    u1 - среднее количество уникальных слов в документе, u2 - среднее количество
    уникальных слов в запросе

--- ПРОСТРАНСТВЕННЯ СЛОЖНОСТЬ --- 
    Хранение словарей с документами O(n * u1) дополнительной памяти,где
    n - количество документов, u1 - количество уникальныз слов в документе, результирующий список
